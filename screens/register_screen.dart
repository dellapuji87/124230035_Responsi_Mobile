...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    ...
    await box.put(user, _password.text);
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.movie, size: 100, color: Colors.pink),
              const SizedBox(height: 20),
              const Text("Buat Akun Baru", style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.pink)),
              ...
              TextButton(
                ...
                child: const Text("Sudah punya akun? Login di sini", style: TextStyle(color: Colors.pink)),
              ),
            ],
          ),
        ),
